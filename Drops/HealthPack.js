class HealthPack {
    constructor(game, x, y) {
        ...
        this.spritesheet = ASSET_MANAGER.getAsset("./Sprites/HealthSprite.png");
    ...
    draw(ctx) {
        ...
        if (this.game.stage == "yacht") {
            if (this.game.player.hitbox.collide(this.hitbox)) {
                ...
                ctx.fillText("Replenish Health: " + this.cost + " Coins", this.game.player.positionx - 325, this.game.player.positiony + 137.5);
                let message;
                if (this.game.player.hpCurrent == this.game.player.hpMax) {
                ...
                ctx.fillText(message, this.game.player.positionx - 275, this.game.player.positiony + 187.5);
            }
        }
    }
}