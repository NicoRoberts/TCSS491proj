class SceneManager {
	...
	loadLevel() {
		...
		let bBoundary = new HBoundary(this.game, 0, 832, 1888, "bottom"); 
		//this.game.addEntsity(bBoundary);

		let tBoundary = new HBoundary(this.game, 0, 0, 1888, "top"); 
		//this.game.addEntity(tBoundary);

		let lBoundary = new VBoundary(this.game, 0, 33, 800, "left"); 
		//this.game.addEntity(lBoundary);

		let rBoundary = new VBoundary(this.game, 1858, 33, 800, "right"); 
